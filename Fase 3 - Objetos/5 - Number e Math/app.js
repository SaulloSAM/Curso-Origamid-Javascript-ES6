 ...
 */
const ano = 2018;
const precos = new Number(99);

/**
 * [NUMBER.ISNAN()] e [NUMBER.ISINTERGER()]
 * 
 * isNaN é um método de Number, ou seja, não faz parte to protótipo.isInterger() verifica se é uma integral.
 */
...
var max = 72; var min = 32;
Math.floor(Math.random() * (max - min + 1)) + min;

// --------------------------------------------------------------
// Retorne um número aleatório
// entre 1050 e 2000
var max = 1050; var min = 2000;
